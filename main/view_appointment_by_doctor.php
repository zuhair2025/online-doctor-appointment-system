...
$sql = "SELECT d.doctorName,d.doctorCategory,d.doctorHospitalName,d.doctorRoomNo,d.doctorFee,d.doctorTime,a.appointmentDate,a.tokenNumber,u.userName,u.userAddress FROM tbl_appointment AS a INNER JOIN tbl_doctor AS d ON a.doctor_Id=d.doctorId INNER JOIN tbl_user AS u ON u.userId=a.userId WHERE appointmentDate='$currentDayDate' AND doctorId=$doctorId ORDER BY appointmentId DESC LIMIT $start, $perpage";
...
<div class="row-fluid sortable">		
    <div class="box span12">
        ...
        <div class="box-content">
            ...
            <table id="resultTable" class="table table-striped table-bordered ">
                <thead>
                    <tr>
                        ...
                        <th width="20%">Patient Address</th>
                ...
                <tbody>
                    ...
                    while ($doctor_info = mysqli_fetch_assoc($query_result)) {
                        ?>
                        <tr>
                            <td><?php echo $doctor_info['userName']; ?></td>
                            <td class="center"><?php echo $doctor_info['userAddress']; ?></td>
            ...
            <?php
            if (isset($page)) {
                $datasql = "SELECT * FROM tbl_appointment WHERE appointmentDate='$currentDayDate' AND doctor_Id=$doctorId ";
